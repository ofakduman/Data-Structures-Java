...
public class InfixToPostfix {
    ...
    public static String convert(String infix)
            throws PostfixEvaluator.SyntaxErrorException, PostfixEvaluator.SyntaxErrorException {
     ...
     */
    void convertToPostfix(String infix) throws PostfixEvaluator.SyntaxErrorException, PostfixEvaluator.SyntaxErrorException {
        ...
        } catch (NoSuchElementException | PostfixEvaluator.SyntaxErrorException ex) {
            throw new PostfixEvaluator.SyntaxErrorException
