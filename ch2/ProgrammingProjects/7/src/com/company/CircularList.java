...
public class CircularList<E> {
    ...
    public MyListIter copyListIterator(ListIterator otherIter){
        MyListIter other = (MyListIter) otherIter;
        MyListIter newOne = new MyListIter(other.index);
        newOne.nextItem = other.nextItem;
        newOne.lastItemReturned = other.lastItemReturned;
        ...
        public void remove() {
            ...
            if(lastItemReturned == nextItem) //if the last call made was a previous call
            {
                if (lastItemReturned == head) { //remove at head
                    ...
                    nextItem.next = head; //erase pointer to tail
